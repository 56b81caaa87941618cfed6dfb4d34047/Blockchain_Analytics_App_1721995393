...
Vue.component("purple_feature_grid_component_1721995396", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our cutting-edge analytics platform that processes and analyzes new blockchain data in real-time, giving you instantaneous insights into emerging trends and patterns.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 font-medium" :class="textSecondaryStyle">Advanced Data Modeling</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our powerful data modeling tools allow you to structure and organize complex blockchain datasets with ease, enabling efficient querying, reporting, and visualization.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Create tailored dashboards that provide at-a-glance overviews of the blockchain metrics that matter most to your business, with customizable visualizations and drill-down capabilities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Predictive Analytics</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Leverage our sophisticated predictive analytics models to forecast future blockchain trends, identify potential risks and opportunities, and make data-driven decisions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform is built on a highly scalable and distributed architecture, ensuring seamless performance and handling ever-increasing volumes of blockchain data.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">We prioritize the security and integrity of your data with industry-leading encryption, access controls, and auditing capabilities, giving you peace of mind.</p></div>
        </div>
    </div>`,
        data() {
            return {
